      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-8 ">
        <div className="grid lg:grid-cols-[1.05fr_1fr] gap-12 lg:gap-16 items-center">
          ...
          <div>
            <a
              href="#report"
              className="group inline-flex items-center gap-2.5 text-[12.5px] text-ink-soft hover:text-jade-900 transition-colors mb-0"
            >
              ...
              <span className="font-bangla">২০২৬ ভাড়া কালেকশন রিপোর্ট</span>
            ...
            <p className="font-serif italic text-coral-600/90 text-[15px] mb-4">
            ...
            <h1 className="font-bold text-jade-900 leading-[0.9] tracking-[-0.035em] text-[44px] sm:text-[56px] lg:text-[64px] xl:text-[80px] mb-8 text-balance">
              ...
              <span className=" text-coral-600">finances</span> <br />
...
function Tick() {
  return (
    <span
      aria-hidden
      className="mt-1 inline-flex size-4.5 shrink-0 items-center justify-center rounded-full bg-jade-500"
    >
      <svg
        width="10"
        height="10"
