        ...
        <section className="py-24 lg:py-32">
            <div className="max-w-[1280px] mx-auto px-5 md:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr] gap-4">
                    ...
                    <article className="md:col-span-2 lg:col-span-1 lg:row-span-2 bg-jade-900 border border-jade-900 text-paper rounded-2xl p-9 flex flex-col justify-between">
                        <div>
