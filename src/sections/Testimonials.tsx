        ...
        <section className="py-24 lg:py-32">
            <div className="max-w-[1280px] mx-auto px-5 md:px-8">
                ...
                <RevealGroup className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr] gap-4">
                    ...
                    <RevealItem className="md:col-span-2 lg:col-span-1 lg:row-span-2 bg-jade-900 border border-jade-900 text-paper rounded-2xl p-9 flex flex-col justify-between">
                        <div>
                        ...
                        <div className="flex items-center gap-3 mt-8">
                            <span className="w-[42px] h-[42px] rounded-full bg-gradient-to-br from-amber-500 to-coral-500 text-white font-bold text-base flex items-center justify-center">
                                TA
                            </span>
                            <div>
                    ...
                    {others.map((t) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mt-auto">
                                <span className="w-[42px] h-[42px] rounded-full bg-gradient-to-br from-cream-2 to-rule text-jade-900 font-bold text-base flex items-center justify-center">
                                    {t.initials}
                                </span>
                                <div>
