...
export default function AdminSubscriptionsPage() {
    ...
    const [editing, setEditing] =
        useState<SubscriptionWithOrganization | null>(null);
                ...
                {isLoading ? (
                    <div className="space-y-2">
                        {[1, 2, 3, 4].map((i) => (
                            <Skeleton
                                key={i}
                                className="h-20 rounded-[10px] bg-paper"
                            />
                        ))}
                    </div>
                ) : isError ? (
        ...
        >
            <AlertDialogContent className="max-w-md">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Manually set plan and status. This bypasses normal
                        billing.
                    </AlertDialogDescription>
                </AlertDialogHeader>
