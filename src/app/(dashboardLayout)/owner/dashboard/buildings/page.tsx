    ...
    return (
        <div className="min-h-screen bg-cream">
            <div className="mx-auto container space-y-6 px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
                        ...
                        <DialogContent className="sm:max-w-2xl">
                            <DialogHeader>
                                ...
                                <DialogDescription className="text-ink-soft">
                                    Add a property to your portfolio. You can add floors
                                    and units after creation.
                                </DialogDescription>
                            </DialogHeader>
                            <BuildingForm
                ...
                <section
                    className="flex flex-wrap items-baseline gap-x-7 gap-y-2 rounded-[14px] border border-rule-soft bg-paper px-5 py-3.5"
                >
                    <SummaryStat
                        label="Buildings"
                ...
                {/* Toolbar */}
                <div className="rounded-[14px] border border-rule-soft bg-paper px-4 py-3">
                ...
                {isLoading ? (
                    ...
                    <ErrorBox message={error instanceof Error ? error.message : "Please try again."} />
