...
// src/app/owner/dashboard/support/[id]/page.tsx
...
export default function SupportTicketDetailPage() {
    ...
    const { data: t, isLoading, isError, error } = useMySupportTicket(
        ticketId,
    );
    const addMessage = useAddMySupportTicketMessage(ticketId);
