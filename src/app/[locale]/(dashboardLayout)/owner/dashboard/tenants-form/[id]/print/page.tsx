      ...
      <div className="mx-auto w-[794px] max-w-full border border-black bg-white p-6 text-[12px] leading-relaxed text-black print:w-full print:border-0 print:p-0">
        ...
        <ol className="space-y-1.5">
          ...
          <li className="flex gap-1">
            ...
            <Field label="ধর্ম" value={form.religion} className="flex-1" />
            <Field
          ...
          <li className="flex gap-1">
            ...
            <Field label="মোবাইল নম্বর" value={form.phone} className="flex-1" />
            <Field label="ই-মেইল আইডি" value={form.email} className="flex-1" />
          </li>
          <li className="flex gap-1">
          ...
          <li>
            ...
            <div className="mt-1 grid grid-cols-2 gap-x-4 gap-y-1 pl-5">
              ...
              <Field label="(খ) সম্পর্ক" value={em?.relationship} />
              <Field label="(গ) ঠিকানা" value={em?.address} />
              <Field label="(ঘ) মোবাইল নম্বর" value={em?.phone} />
            </div>
          </li>
            ...
            <table className="mt-1 w-full border-collapse text-[11px]">
              <thead>
                <tr>
                  ...
                  <th className="border border-black px-1 py-0.5">নাম</th>
                  <th className="border border-black px-1 py-0.5 w-28">বয়স</th>
                  <th className="border border-black px-1 py-0.5 w-28">পেশা</th>
            ...
            <div className="flex gap-1">
              ...
              <div className="flex-1 space-y-1">
                <div className="grid grid-cols-2 gap-x-4">
                  <Field label="গৃহকর্মীর নাম" value={maid?.name} />
                  <Field label="জাতীয় পরিচয়পত্র নং" value={maid?.nidNumber} />
                </div>
                <div className="grid grid-cols-2 gap-x-4">
                  <Field label="মোবাইল নম্বর" value={maid?.contactNumber} />
                  <Field
                    label="স্থায়ী ঠিকানা"
          ...
          <li>
            <div className="flex gap-1">
              ...
              <div className="flex-1 space-y-1">
                <div className="grid grid-cols-2 gap-x-4">
                  <Field label="ড্রাইভারের নাম" value={driver?.name} />
                  <Field
                ...
                <div className="grid grid-cols-2 gap-x-4">
                  <Field label="মোবাইল নম্বর" value={driver?.contactNumber} />
                  <Field
                    label="স্থায়ী ঠিকানা"
              ...
              <div className="flex-1 space-y-1">
                <div className="grid grid-cols-2 gap-x-4">
                  <Field
                    ...
                    value={previous?.name}
                  />
                  <Field label="মোবাইল নম্বর" value={previous?.contactNumber} />
                </div>
                <Field label="ঠিকানা" value={previous?.address} />
              </div>
            </div>
          </li>
        ...
        <div className="mt-10 flex items-end justify-between">
          <div className="text-center">
            <div className="w-40 border-t border-black pt-1">তারিখ</div>
          </div>
          <div className="text-center">
