...
export default function LeaseDetailPage() {
  ...
  const totalMonthly = Number(lease.monthlyRent) + Number(lease.serviceCharge);
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <span
                          className={cn(
                            "rounded-md border px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider",
                            getInvoiceStatusTone(inv.status),
                          )}
                        >
                          {inv.status}
                        </span>
  ...
  return (
    <div
      className={cn(
        ...
        warn ? "border-coral-100 bg-coral-50/70" : "border-rule-soft bg-paper",
      )}
    >
