  ...
  return (
    <div className="sticky top-0 z-50 bg-cream/85 dark:bg-night/85 backdrop-blur-md border-b border-rule-soft dark:border-white/10">
      <nav className="container mx-auto grid grid-cols-[auto_1fr_auto] items-center gap-14 py-4 px-5 md:px-8">
        ...
        >
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" style={{ display: "block" }} viewBox="366.667 680 1230.667 682.667" className="h-7 w-auto absolute -top-3.5 left-[-15.5px]" preserveAspectRatio="none">
  ...
  <path transform="translate(0,0)" fill="#247460" d="M 1177.96 977.928 L 1241.14 977.684 C 1241.64 997.869 1241.19 1020.46 1241.2 1040.81 L 1177.98 1040.94 C 1177.81 1019.94 1177.8 998.932 1177.96 977.928 z"></path>
        ...
        <ModeToggle />
          ...
          <button
            ...
            className="lg:hidden text-jade-900 dark:text-jade-50"
          >
