        ...
        {values.billingMode === "FIXED_SEPARATE" && (
          <div className="space-y-3 rounded-[10px] border border-rule-soft bg-cream/40 px-3.5 py-3">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              <Field label="Electricity" htmlFor="l-elec">
                <UtilityInput
                  ...
                  onChange={(v) => set("electricityCharge", v)}
                  placeholder="2,500"
                />
              </Field>
            ...
            <p className="text-[11.5px] text-ink-soft">
              Leave any field at <span className="tabular-nums">0</span> if that
              utility isn&apos;t billed by you. These are added to the monthly
              invoice on top of rent + service charge.
            </p>
          </div>
        )}
      </FormSection>
